                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      disabled={!candidate?.url}
                      onClick={async () => {
                        if (onGetEmail && candidate?.url && candidate?.id) {
                          await onGetEmail(candidate.url, candidate.id);
                        }
                      }}
                    >
                                      ...
                                      <div className="mt-3 p-3 bg-purple-50/50 rounded-md border border-purple-100/50">
                                        ...
                                        <div className="space-y-4">
                                          ...
                                          <div>
                                            ...
                                            <ul className="list-disc list-inside text-xs text-purple-700/90 space-y-0.5">
